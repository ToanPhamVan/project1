...
<body>
    <!-- <header>
            ...
            <form class="registration_form" name="registration_form" action="" method="post">
                ...
                <h1 style="font-size: 25px;">Sign Up </h1>
                    <div class="registration_form_input">
                            ...
                            <input class="form-control" type="text" name="contact" id="" placeholder="Enter your phone number"> <br> <br>
            ...
            if(isset($_POST['submit']))
        {
            ...
            if($count==0)
            {
                mysqli_query($db,"INSERT INTO `admin` VALUES('','$_POST[firstName]','$_POST[lastName]','$_POST[userName]','$_POST[password]','$_POST[email]','$_POST[contact]','userimage.png');");
                ?>
