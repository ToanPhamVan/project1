...
<body>
    <form method="post" class="issue_form" action="">
        ...
        <div class="issue_form_input" style="height: 400px; width: 300px; text-align: center">
            <input class="form-control" type="text" name="issue_id" placeholder="Issue Id" required> 
            <input class="form-control" type="text" name="id" placeholder="Student Id" required> 
            <input class="form-control" type="text" name="bid" placeholder="Book Id" required> 
            <input class="form-control" type="text" name="issue_time" placeholder="Issue time YYYY-MM-DD" required> 
            <input class="form-control" type="text" name="return_time" placeholder="Return time YYYY-MM-DD" required> <br>   
